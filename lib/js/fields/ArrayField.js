...
var ArrayField = function (_React$Component) {
  ...
  function ArrayField(props) {
    ...
    _this.state = {
      editing: props.formData ? props.formData.map(function (item, index) {
        return !(0, _validation.errorSchemaIsValid)(props.errorSchema[index]);
      }) : [true]
    };
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            {
              type: 'button',
              className: (0, _classnames2.default)('usa-button-secondary', 'va-growable-add-btn', {
