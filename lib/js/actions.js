...
var _data = require('./utilities/data');
...
function submitToUrl(body, submitUrl, recordEvent) {
  return new Promise(function (resolve, reject) {
    ...
    var userToken = _data2.default.get('sessionStorage.userToken', window);
    if (userToken) {
...
function submitForm(formConfig, form) {
  var recordEvent = formConfig.recordEvent ? formConfig.recordEvent.bind(formConfig) : console.error.bind(console); // eslint-disable-line no-console
