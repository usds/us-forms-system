...
var FormApp = function (_React$Component) {
  ...
  _createClass(FormApp, [{
    ...
    value: function componentWillMount() {
      var additionalRoutes = this.props.formConfig.additionalRoutes;

      this.nonFormPages = [];
      if (additionalRoutes) {
        this.nonFormPages = additionalRoutes.map(function (route) {
          return route.path;
        });
      }
    ...
    value: function render() {
      ...
      var lastPathComponent = currentLocation.pathname.split('/').pop();
      var isIntroductionPage = trimmedPathname.endsWith('introduction');
      var isNonFormPage = this.nonFormPages.includes(lastPathComponent);
      ...
      if (!isNonFormPage && (0, _helpers.isInProgress)(trimmedPathname)) {
