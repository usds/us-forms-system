...
function mapStateToProps(state, ownProps) {
  ...
  var chapters = chapterNames.map(function (chapterName) {
    ...
    var activePages = (0, _helpers.getActivePages)(pages, formData);
    var expandedPages = (0, _helpers.expandArrayPages)(activePages, formData);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ReviewChapters);
