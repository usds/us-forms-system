...
var _SegmentedProgressBar = require('@department-of-veterans-affairs/formation/SegmentedProgressBar');
...
var FormNav = function (_React$Component) {
  ...
  _createClass(FormNav, [{
    ...
    value: function render() {
      ...
      var expandedPageList = (0, _helpers.expandArrayPages)(pageList, formData);
      var eligiblePageList = (0, _helpers.getActivePages)(expandedPageList, formData);
